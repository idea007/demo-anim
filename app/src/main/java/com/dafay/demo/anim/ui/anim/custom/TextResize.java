...
public class TextResize extends Transition {
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        LogUtils.w("captureStartValues");
        captureValues(transitionValues);
    }

    @Override
    public void captureEndValues(TransitionValues transitionValues) {
        LogUtils.w("captureEndValues");
        captureValues(transitionValues);
    }
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        LogUtils.w("captureValues tag=" + view.getTag());
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues,
        ...
        if (startData.textColor != endData.textColor) { final PropertyValuesHolder textColorProp = PropertyValuesHolder.ofObject("textColor",
